...
class StartImageView: UIView {
    ...
    private func setup() {
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(startImageNotification(_:)), name: NotificationKey.start_image_notification, object: nil)
